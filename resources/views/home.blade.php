            ...
            <div class="flex items-center">
                <div style="max-width: 40rem">
                    ...
                    <p class="text-gray-600 mt-4">
                        Track Your Borrowed Books and Manage Your Library. Discover New Books to Borrow and Explore Your
                        Interests.
                        Browse a Wide Selection of Digital and Physical Books. Borrow and Return Books Easily, Anytime,
                        Anywhere.
                    </p>
            ...
            <div class="flex flex-col md:flex-row justify-center items-center mt-8">
                <div class="text-center md:w-1/2">
                    <p class="text-gray-600">
                        Meet Kindred Book Lovers In A Local Meetup Book Club! Fiction Or Non Fiction, Paperback Or
                        Hardcover, You
