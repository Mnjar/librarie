...
<body>
    ...
    <nav class="fixed top-0 z-50 w-full bg-white border-gray-200 dark:bg-indigo-800 dark:border-gray-700">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center">
                ...
                <div class="z-50 hidden fixed my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-indigo-800 dark:divide-gray-600" id="dropdown-user">
  ...
  <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-indigo-800 dark:border-gray-700" aria-label="Sidebar">
     <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-indigo-800">
